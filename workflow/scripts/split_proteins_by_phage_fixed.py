...
Usage:
    python split_proteins_by_phage_fixed.py --input proteins.faa --output-dir split_proteins/
"""
...
def extract_phage_id(header):
    ...
    # Fallback: Just return the base header if we can't identify a clear pattern
    return base_header
